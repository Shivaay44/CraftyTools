  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-3.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800 text-xs font-semibold text-emerald-800 dark:text-emerald-300 flex items-center gap-2">
        ...
        <span>Generated locally using your browser's cryptographic random generator (<code className="font-mono px-1 py-0.5 rounded bg-emerald-100 dark:bg-emerald-900 text-emerald-900 dark:text-emerald-200">crypto.getRandomValues</code>). Never transmitted or stored.</span>
      </div>
